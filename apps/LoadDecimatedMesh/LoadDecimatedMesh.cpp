...
#define APPNAME _T("LoadDecimatedMesh")
...
bool Initialize(size_t argc, LPCTSTR* argv)
{
  ...
  config.add_options()
    ...
    ("mesh,m", boost::program_options::value<std::string>(&OPT::meshToLoad), "/tmp/mesh.ply");
  ...
  std::cout << "Mesh path: " << OPT::meshToLoad << std::endl;
  Util::ensureValidPath(OPT::meshToLoad);
  Util::ensureUnifySlash(OPT::meshToLoad);
